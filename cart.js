//.get .then gets us the data from database but we need to refresh every time we want to see the changes.
//Hence onSnapshot is used to auto refresh.
    ...
    db.collection("cart-items").onSnapshot((Snapshot) => {
        ...
        Snapshot.docs.forEach((doc) => {
            cartItems.push({
                ...
                // ... is the spread operator it saves us coe reusability.
...
function generateCartItems(cartItems) {
    ...
    cartItems.forEach((item) => {
         ...
         <img class="w-full h-full object-conatain" src="${item.image}">
      </div>
